document.writeln(`<canvas id='bg_canvas' style='width:100%;height:100%;position:fixed;top:0;left:0;z-index:-1;background: #000 url(${Integration_LocalConst.STATIC_PATH}images/bgCanvas.jpg) repeat;'></canvas>`);
